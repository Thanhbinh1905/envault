...
This document covers the workspace layout, build/verification commands, and CLI usage for local development.
For the security model and threat model, see [docs/threat-model.md](threat-model.md).
