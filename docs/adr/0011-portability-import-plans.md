...
Destination names, identifiers, profile activation, and secret values can also change after a preview.
...
Profile and workspace packages transfer encrypted secret-value ciphertext and DEKs wrapped by the package transfer key.
